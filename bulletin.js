...
async function scrapeCourses() {
    try {
        ...
        // Save results to JSON in the correct location (back out of current folder, then into results/)
        const outputFile = path.join(__dirname, 'results', 'bulletin.json'); // Go up one level before saving
